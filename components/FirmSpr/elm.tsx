...
export class FirmElm extends React.Component<IFirmElmProps, IFirmElmState>{
	...
	loadAccs = async () => {
		if(this.props.elmId) {
			const data = await trpc.spr.firmAcc.getElm.query({ firmId: this.props.elmId});
	...
	componentDidUpdate(prevProps: Readonly<IFirmElmProps>, prevState: Readonly<ITovar>, snapshot?: any): void {
